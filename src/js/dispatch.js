...
function outputAuditLog(auditLog, callType) {
  ...
  if (!ta) {
    ...
    ta.style.cssText = 'position:fixed;bottom:0;left:0;width:100%;height:72px;font-family:monospace;font-size:11px;background:#1a1a1a;color:#ccc;border:none;border-top:2px solid #f97316;padding:8px 10px;box-sizing:border-box;z-index:9999;resize:none;';
    ...
    closeBtn.style.cssText = 'position:fixed;bottom:74px;right:12px;z-index:10000;background:#f97316;color:#fff;border:none;border-radius:4px;padding:4px 12px;font-size:12px;font-weight:bold;cursor:pointer;';
